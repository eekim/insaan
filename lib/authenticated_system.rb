module AuthenticatedSystem
  protected
    ...
    def logged_in?
      current_user != :false && current_user.enabled?
    end
    ...
    def check_role(role)
      unless logged_in? && @current_user.has_role?(role)
        access_denied("You do not have the permission to do that.")
      end
    end
    ...
    #
    def login_required
      authorized? || access_denied("You must be logged in to view this page.")
    end
